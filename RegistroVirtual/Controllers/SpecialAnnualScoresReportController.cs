...
{
    [SessionAuthorize]
    public class SpecialAnnualScoresReportController : Controller
    {
        ...
        public ActionResult GeneratePDF(string selectedClass, string selectedYear, string selectedSubject)
        {
            try
            {
                ...
                string fileName = string.Format("Reporte-Calificaciones-Especial-2018-Anuales-{0}.pdf", @class.Name.Replace(" ", ""));
